...
def do_sna(filtered_content, final_Noun_words, num):
	#------------------------------------------------
	# 단어 빈도 파악하기 (Frequency analysis)
	c = Counter(final_Noun_words)

	# To get the list of top 10 most frequently used words
	...
	G = form_network(G, article_sentences, list_of_words)
	return G
	
def do_sna2(filtered_content, selected_words):
